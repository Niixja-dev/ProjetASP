    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Utiliser PasswordSignInAsync qui gère tout le processus de connexion
                ...
                if (result.IsLockedOut)
                {
                    ...
                    ModelState.AddModelError("", "Compte verrouillé.");
                }
                else if (result.IsNotAllowed)
                {
                    _logger.LogWarning("Connexion non autorisée: {Email}", model.Email);
                    ModelState.AddModelError("", "Connexion non autorisée.");
                }
                else
                {
